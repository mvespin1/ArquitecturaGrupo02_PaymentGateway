...
public class GtwTransaccionService {
    ...
    @Transactional
    public GtwTransaccion create(GtwTransaccion transaccion) {
    ...
    public List<GtwTransaccion> findByEstado(String estado) {
        validarEstadoTransaccion(estado);
        return repository.findByEstado(estado);
    }

    public List<GtwTransaccion> findRecurrentTransactionsToProcess(LocalDate fechaActual) {
